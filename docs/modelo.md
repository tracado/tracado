...
O Traçado existe para que você **nunca digite a mesma informação duas vezes** e
...
O que a organização protege. O Traçado separa ativo **primário** (processo,
